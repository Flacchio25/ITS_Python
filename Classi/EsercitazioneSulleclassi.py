...
def add_movies(self, director_name:str, movies: list[str])-> None:
    ...
    # metodo per rimuovere un film dalla lista dei film prodotti da un regista
    ...
    # metodo che ritorna una lista contenenti i nomi di tutti i registi del catalogo
    def list_directors(self) -> list[str] | str:
        ...
        # altrimenti ( se il dizionario è vuoto)
            ...
            return f"Non ci sono registi nel catalogo perchè il catalogo è vuoto"
